          ...
          <div className="input-row">
            <label>
              ...
              <input
                ...
                value={addBook.isbn}
                onChange={(e) =>
                  setAddBook({ ...addBook, isbn: e.target.value })
                }
              />
            </label>
        ...
        <div className="input-row">
          <label>
            ...
            <input
              ...
              value={addBook.cover}
              onChange={(e) =>
                setAddBook({ ...addBook, cover: e.target.value })
              }
            />
          </label>
          <label>
        ...
        <div className="input-row">
          <label>
            ...
            <input
              ...
              onChange={(e) =>
                setAddBook({ ...addBook, genres: e.target.value })
              }
            />
          </label>
          <label>
            ...
            <input
              ...
              onChange={(e) =>
                setAddBook({ ...addBook, publisher: e.target.value })
              }
            />
          </label>
        </div>
